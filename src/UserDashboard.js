...
const mockNotifications = [
  ...
  {
    id: 2,
    message: "Please upload your latest salary proof.",
    timestamp: "1 day ago",
    unread: false,
  },
  {
    id: 3,
    message: "Your credit card statement is available.",
...
const mockServices = [
  {
    name: "Debit Card",
    status: "Active",
    icon: <CreditCard className="w-6 h-6 text-sc-blue-600" />,
  },
  {
    name: "Credit Card",
    status: "Inactive",
  ...
  },
  {
    name: "Insurance",
    status: "Active",
    icon: <BellRing className="w-6 h-6 text-sc-blue-600" />,
  },
];
...
const App = () => {
  ...
  const [loanStatus, setLoanStatus] = useState("In Review");
          ...
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <div className="ml-4 flex items-center gap-3">
                ...
                <div className="w-8 h-8 bg-sc-green-600 rounded-full flex items-center justify-center">
      ...
      <div className="min-h-screen bg-gray-100 p-4 sm:p-8 font-sans">
        <div className="w-full max-w-7xl mx-auto space-y-8">
          ...
          <motion.header
            ...
            className="flex flex-col sm:flex-row items-center justify-between p-6 bg-white rounded-2xl shadow-xl"
          >
            ...
            <button
              ...
              className="mt-4 sm:mt-0 flex items-center px-6 py-3 bg-sc-blue-600 text-white font-medium rounded-full shadow-lg hover:bg-sc-blue-700 transition-colors"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* Notifications Card (Column 1) */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.2, duration: 0.5 }}
              className="lg:col-span-1 p-6 bg-white rounded-2xl shadow-xl flex flex-col"
            >
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                  <Bell className="w-5 h-5 text-sc-green-600" />
                  Notifications
                </h2>
                {unreadCount > 0 && (
                ...
                {notifications.slice(0, 2).map((n) => (
                  <div
                    ...
                    className={`p-4 rounded-lg border transition-colors ${
                      n.unread
                        ? "bg-sc-blue-50 border-sc-blue-200"
              ...
              <button className="mt-6 text-sm font-medium text-sc-blue-600 hover:text-sc-blue-800 transition-colors self-start">
                See all notifications
              </button>
            </motion.div>

            {/* Loan Status & Services (Column 2-3) */}
            <div className="lg:col-span-2 flex flex-col gap-8">
              ...
              <motion.div
                ...
                className="p-8 bg-white rounded-2xl shadow-xl flex-grow"
              >
                <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                  <FileText className="w-5 h-5 text-sc-green-600" />
                ...
                <div className="p-6 bg-gray-50 rounded-lg shadow-inner text-center">
                  ...
                  <div className="mt-6">
                    <button className="flex items-center mx-auto text-sc-blue-600 hover:text-sc-blue-800 font-medium text-sm">
              ...
              >
                <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                  <Briefcase className="w-5 h-5 text-sc-green-600" />
                  My Services
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {mockServices.map((service) => (
                    <div
                      key={service.name}
                      className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-200 flex items-center justify-between"
                    >
